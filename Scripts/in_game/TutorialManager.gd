...
#   3 - Ouvrir le menu hexagonal (attend clic gauche sur navire)
...
const ETAPES: Array = [
	...
	[
		...
		"Vous pouvez vous déplacer sur la carte avec les touches fléchées ⬆️⬇️⬅️➡️, ou en approchant la souris des bords de l'écran.\n\nPour zoomer/dézoomer, utilisez la molette de la souris 🖱️.\n\nPour changer de navire actif, appuyez sur Tab ↹.\n\n➡️ Essayez de naviguer sur la carte, puis cliquez sur « Suivant ».",
		true
	],
	[
		"🚢 Déplacer un navire",
