...
const COMMANDES: Array = [
	["🖱️ Clic gauche sur navire", "Ouvrir le menu d'actions"],
	["🖱️ Clic droit sur case", "Déplacer le navire (1⚡ par case, confirmation requise)"],
	["🖱️ Clic gauche sur case ennemie", "Attaquer la case ciblée (10⚡)"],
